...
from arl.msg.views import (
    ...
    employee_email_report_view,
    fetch_twilio_data,
    get_group_emails,
    get_task_status,
    message_summary_view,
    sendgrid_webhook,
...
urlpatterns = [
    ...
    path(
        "employee-email-report/",
        employee_email_report_view,
        name="employee_email_report",
    ),
    ...
    path(
        "twilio/webhook/short-link/",
        twilio_short_link_webhook,
        name="twilio_short_link_webhook",
    ),
    path(
        "short-link-sms/report/", fetch_shortlink_sms_data, name="shortened_sms_report"
    ),
    path("comms/draft/<int:draft_id>/", edit_draft_email, name="edit_draft_email"),
    path(
        "comms/draft/<int:draft_id>/delete/",
        delete_draft_email,
