...
from .views import CheckPhoneNumberUniqueView, register, send_bulk_sms, sms_form, request_verification, check_verification_token
...
urlpatterns = [
    ...
    path('check-verification/', check_verification_token, name='check_verification'),
